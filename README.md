...
## 🌱 เกี่ยวกับโปรเจกต์นี้ (ฉบับมือใหม่กำลังงม!)
สวัสดีค่ะทุกคน! Repository นี้เป็นพื้นที่รวบรวมงานออกแบบหน้าเว็บไซต์ (HTML & CSS) ที่เพิ่งลองฝึกทำ ยอมรับเลยว่าช่วงแรกๆ มีมึนตึ้บกับพวกโค้ดและการจัดเลย์เอาต์พอสมควร แต่ก็ค่อยๆ ลองผิดลองถูก เปิดเว็บดูรีวิว จนออกมาเป็นหน้าเว็บเหล่านี้ค่ะ 

ทำส่งอาจารย์แล้ว ก็เลยขอแปะเก็บไว้เป็นโน้ตส่วนตัว เผื่อวันไหนลืมคำสั่ง CSS จะได้กลับมาแอบดูโพยตัวเองตรงนี้แหละ 📖✍️
...
## 🛠️ เครื่องมือที่ใช้ (เท่าที่มือใหม่จะรู้จัก 😄)
- **HTML5 / CSS3:** ภาษาหลักที่ใช้เขียนโครงสร้างเว็บและแต่งหน้าตา (พยายามจำ tag ให้ได้อยู่ค่ะ ฮ่าๆ)
- **GitHub Pages:** ตัวช่วยเอาเว็บขึ้นออนไลน์ให้กดดูได้จริง

---

## 🙏 ขอบคุณผู้มีพระคุณทุกท่าน!
งานนี้จะรอดมาจนส่งได้ ต้องขอขอบคุณความช่วยเหลือจากรอบด้านเลยค่ะ:

- **👨‍🏫 อาจารย์ผู้สอน:** ขอบคุณอาจารย์ที่สอนเขียนโค้ด 
- **👯‍♀️ เพื่อนร่วมคลาส:** ขอบคุณเพื่อนที่อนุญาตให้ไปขอเอารูปภาพ มาประกอบหน้าเว็บ
- **🤖 AI สุดฉลาด:** ขอบคุณ AI (เพื่อนซี้แก้บั๊ก) ที่คอยช่วยอธิบายโค้ด ช่วยแก้พาร์ทที่รันไม่ผ่าน และช่วยเกลาภาษาให้ตลอดรอดฝั่ง

---

<div align="center">
  <i>Learning by doing • เก็บไว้ดูทบทวนตัวเองฉบับมือใหม่ 📚✨</i>
</div>
